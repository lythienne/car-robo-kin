...
# axd['left'].set_xlim(-10, 10)
# axd['left'].set_ylim(-10, 10)
...
def tracePath(path, step_size, rate):
    ...
    speeds = wheelSpeeds(v_car, np.pi/2, omega, A, B)
    ...
    #                wheelSpeeds(v_car, 90, omega, A, B), MAXSPEED)
    #     speeds = wheelSpeeds(v_car, 90, omega, A, B)
    #     # plt.pause(1/rate)
